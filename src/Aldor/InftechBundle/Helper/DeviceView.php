...
namespace Aldor\InftechBundle\Helper;
...
use SunCat\MobileDetectBundle\Helper\DeviceView as DeviceViewParent;
 ...
 */
class DeviceView extends DeviceViewParent
{
    const HEADER_NAME        = 'x-device-type';
    ...
    {
        $response->headers->set(self::HEADER_NAME, self::VIEW_NOT_MOBILE);
    ...
    {
        $response->headers->set(self::HEADER_NAME, view);
